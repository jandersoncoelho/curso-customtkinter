...
def configurar_janela():
    ...
    janela = ctk.CTk()
    janela.title("Exemplo de Imagens - Aula13")
...
def criar_widgets(janela):
    ...
    criar_label(
        janela, "Imagens com CustomTkinter")
    criar_imagem_tema(janela)
    criar_botao(janela)
...
class Aula13Frame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        try:
            ...
            ctk.CTkLabel(self, text="Aula 13 - Imagens (embutido)").pack(padx=20,pady=20)
